...
/**
 * Moodle mooin Theme is using Moodle's bootstapbase and 
 * based on the clean theme template to allow using 
    ...
    <nav role="navigation" class="navbar-inner">
        <div class="oc_inner_layout">
		  <div class="inner_content">
		    <a name="anfang"></a> <?php /* Sprungmarke */ ?>
...
<div id="page">
    <div id="page-content" class="row-fluid">
            ...
            <section id="region-main" class="container-fluid oc_contain_layout"> <?php /* class="span8 pull-right" class="span8" */ ?>
                    <?php
